...
const AddTransactionForm = ({
  ...
  const {
    register, // Permet de lier les champs du formulaire.
    setValue, // Permet de mettre à jour la valeur d'un champ.
    handleSubmit, // Gère la soumission du formulaire.
    formState: { errors }, // Contient les erreurs de validation du formulaire.
    watch, // Permet de suivre les changements d'une valeur spécifique.
